...
export default function Hero() {
    ...
    return (
        ...
        >
            ...
            {/* Main Content Area */}
            <div className="relative z-10 w-full max-w-7xl mx-auto px-8 md:px-12 flex flex-col md:flex-row-reverse items-center justify-center gap-16 md:gap-32 h-full pt-20 hero-parallax">
